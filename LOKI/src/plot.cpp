...
void t_plot::hTime()
{
   ...
   t_workingDir workingDir;  string currentFolderPath = workingDir.GetCurrentWorkingDir();
   
   string pathToEps = "/LOKI/gnuplot/eps/";
   string figureName = "hTime.eps";
   
   string out = currentFolderPath + pathToEps + figureName;

   
   // output
   // string out = "~/Work/SW/LOKI/LOKI/gnuplot/eps/hTime.eps";
...
void t_plot::hDeseas()
{
   ...
   string pathToEps = "/LOKI/gnuplot/eps/";
   string figureName = "hDeseas.eps";
   
   string out = currentFolderPath + pathToEps + figureName;

   // output
   //   string out = "~/Work/SW/LOKI/LOKI/gnuplot/eps/hDeseas.eps";
...
void t_plot::hTK()
{
   ...
   string pathToEps = "/LOKI/gnuplot/eps/";
   string figureName = "hTK.eps";
   
   string out = currentFolderPath + pathToEps + figureName;

   
   // output
   //string out = "~/Work/SW/LOKI/LOKI/gnuplot/eps/hTK.eps";
...
void t_plot::outlier()
{
   ...
   // output
   string out = "~/Work/SW/LOKI/LOKI/gnuplot/eps/outliers.eps";
   ...
   plot("set size 3.0,1.0");
   plot("set style fill solid 0.5");
   plot("plot \'~/Work/SW/LOKI/LOKI/gnuplot/outliersDD\' u 1:2 t 'Original TS' w l lc rgb 'black' ,\'' u 1:3 t 'Regression' w l lc rgb '#09ad00' lw 3 ,\'' u 1:4 not w l lc rgb '#09ad00' lw 1 ,\'' u 1:5 not '' w l lc rgb '#09ad00' lw 1");
