...
// The offset is the cumulative GPS-UTC difference in seconds:
//   GPS_time = UTC_time + offset
// GPS clocks were set to match UTC at the GPS epoch (1980-01-06).
// Each subsequent IERS leap second increments the GPS-UTC offset by 1.
// Entries before 1980 are omitted -- GPS-UTC was 0 at GPS epoch.
// Last entry: 2017-01-01 (offset = 18 s). Update if IERS announces new leap second.
// Source: IERS Bulletin C / USNO.
constexpr std::array<LeapEntry, 19> LEAP_SECOND_TABLE{{
    {44239.0,  0},  // 1980-01-01
    {44786.0,  1},  // 1981-07-01
    {45151.0,  2},  // 1982-07-01
    {45516.0,  3},  // 1983-07-01
    {46247.0,  4},  // 1985-07-01
    {47161.0,  5},  // 1988-01-01
    {47892.0,  6},  // 1990-01-01
    {48257.0,  7},  // 1991-01-01
    {48804.0,  8},  // 1992-07-01
    {49169.0,  9},  // 1993-07-01
    {49534.0, 10},  // 1994-07-01
    {50083.0, 11},  // 1996-01-01
    {50630.0, 12},  // 1997-07-01
    {51179.0, 13},  // 1999-01-01
    {53736.0, 14},  // 2006-01-01
    {54832.0, 15},  // 2009-01-01
    {56109.0, 16},  // 2012-07-01
    {57204.0, 17},  // 2015-07-01
    {57754.0, 18},  // 2017-01-01  <- last known entry
}};
